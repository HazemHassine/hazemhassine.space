...
+------------------------------------+   +--------------------------------+`,
  ...
  },
  {
    ...
    overview: [
      ...
      "Engineered for sub-second page loads and zero hydration flicker, the application uses Next.js static page generation, server components, and Tailwind CSS variables for high-contrast accessibility."
    ],
    problemStatement: {
...
+-------------------------------------------------------------------------+`,
    ...
    keyCapabilities: [
      ...
      {
        title: "Sub-Second Static Generation",
        description: "Pre-renders all static paths and routes at build time with Turbopack for optimal Lighthouse scores and instant transitions."
      },
      {
