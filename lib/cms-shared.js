export const pageContentDefaults = {
  ...
  home: {
    marquee: [
      ...
      "SHIPPING TOO MANY SIDE PROJECTS",
    ],
  ...
  projects: {
    ...
    title: "/ PROJECTS",
    introduction: "Engineered AI systems, agent-enabled control planes, explainable analytics pipelines, and interactive developer tools.",
