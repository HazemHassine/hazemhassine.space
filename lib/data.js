...
export const siteConfig = {
  ...
  bio: [
    "AI-focused software engineer building agentic systems, developer tools, and thoughtful products.",
    "My background spans software engineering, federated-learning research, IT systems, and product analytics. Currently, I'm pursuing my Master's in Intelligent Interactive Systems at Bielefeld University with a focus on AI and ML. Alongside academia, my engineering projects focus on agentic AI, RAG, developer tooling, and full-stack AI systems.",
  ],
...
export const experience = [
  ...
  },
  {
    ...
    location: "Tunisia",
    description:
      "Built an e-commerce website for a client using standard web technologies, translating requirements into a complete implementation with clean, maintainable code.",
  },
];
...
export const education = [
  ...
  },
  {
    ...
    description: "German-equivalent grade: 2.4. Focused on Fundamentals of Big Data and Artificial Intelligence.",
  }
];
...
export const projects = [
  {
    ...
    description:
      "A safety-oriented control plane for understanding and operating development environments. Connects projects, containers, processes, ports, and configuration in a live topology with typed operations, human approval gates, rollback-aware editing, and optional agent interfaces.",
